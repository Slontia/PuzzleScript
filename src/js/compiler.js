...
function expandDirectionalRules(rule, state) {
    ...
    */
    ...
    for (let rotation = 0; rotation < 4; rotation++) {
        ...
        // Process in order of their name length (longest first) to avoid partial matches
        const sortedObjectNames = Object.keys(objectVariantsMap).sort((a, b) => b.length - a.length);
